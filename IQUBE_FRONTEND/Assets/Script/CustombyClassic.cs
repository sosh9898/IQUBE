...
public class CustombyClassic : MonoBehaviour
{
	...
	public void nextbtn()
	{
        ...
        if (custom_mode == 1)
        {
            if (PlayerPrefs.HasKey("m_count"))
            {
                count = PlayerPrefs.GetInt("m_count");
            }
        }
	...
	public void OnMouseDown()
	{
		...
		if (cubes != null)
		{
			...
			{
				if (state [(x) + y * 8] != 1 && state [(x) + y * 8] != 2 && state [(x) + y * 8] != 11 && state [(x) + y * 8] != 12 && state [(x) + y * 8] != 13 &&
				    state [(x) + y * 8] != 14 && state [(x) + y * 8] != 15 && state [(x) + y * 8] != 16 && state [(x) + y * 8] != 17 && state [(x) + y * 8] != 21 &&
				    state [(x) + y * 8] != 22 && state [(x) + y * 8] != 23 && state [(x) + y * 8] != 24 && state [(x) + y * 8] != 25 && state [(x) + y * 8] != 26 &&
				    state [(x) + y * 8] != 27 && state [(x) + y * 8] != 28 && state [(x) + y * 8] != 31 && state [(x) + y * 8] != 32 && state [(x) + y * 8] != 33 &&
				    state [(x) + y * 8] != 34 && state [(x) + y * 8] != 35 && state [(x) + y * 8] != 36) {
