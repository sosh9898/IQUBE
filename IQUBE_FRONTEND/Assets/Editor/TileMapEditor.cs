namespace CBX.Unity.Editors.Editor
{
    ...
    public class TileMapEditor : Editor
    {
        ...
        private void Draw()
        {
            ...
            GameObject cube = GameObject.Find(string.Format("Tile_x{0}_y{1}", tilePos.x, tilePos.y));
            ...
            if (cube == null)
            {
                ...
                DestroyImmediate(cube.gameObject.GetComponent(typeof(BoxCollider)));

                cube.gameObject.AddComponent(typeof(BoxCollider2D));
            ...
            cube.transform.GetComponent<MeshRenderer>().material= Resources.Load("something", typeof(Material)) as Material;
            ...
            cube.name = string.Format("Tile_x{0}_y{1}", tilePos.x, tilePos.y);
        }
